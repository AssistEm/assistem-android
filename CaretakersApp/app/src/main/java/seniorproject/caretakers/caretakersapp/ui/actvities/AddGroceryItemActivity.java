...
import seniorproject.caretakers.caretakersapp.presenters.AddGroceryPresenter;
...
public class AddGroceryItemActivity extends BaseActivity implements
    ...
    View.OnClickListener mSubmitClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            GroceryItem item = new GroceryItem(title, description, quantity, location, time);
            presenter.addGroceryItem(item);
        }
    };
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_add_grocery_item, menu);
        return true;
    }
