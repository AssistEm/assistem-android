...
public class AddAvailabilityDialog extends DialogFragment implements
    ...
    private AddAvailabilityListener mListener;
    ...
    public void setAddAvailabilityListener(AddAvailabilityListener listener) {
        mListener = listener;
    }

    public void removeAddAvailabilityListener() {
        mListener = null;
    }
