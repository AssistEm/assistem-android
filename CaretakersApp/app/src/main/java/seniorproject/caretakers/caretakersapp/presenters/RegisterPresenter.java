...
import seniorproject.caretakers.caretakersapp.data.model.Caretaker;
...
public class RegisterPresenter extends AuthPresenter implements Presenter<RegisterView> {
    ...
    public void register(String email, String password, String confirmPassword,
        ...
        if(email.isEmpty() || password.isEmpty() || confirmPassword.isEmpty() || communityName.isEmpty()
                || firstName.isEmpty() || lastName.isEmpty() || phone.isEmpty() || communitySearch.isEmpty() ) {
