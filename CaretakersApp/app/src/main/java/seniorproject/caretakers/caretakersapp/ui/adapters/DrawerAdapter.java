...
public class DrawerAdapter extends BaseAdapter {
    ...
    private static final int[] DRAWER_SECTIONS_CARETAKER = {
            R.string.drawer_calendar, R.string.drawer_grocery_list, R.string.drawer_community, R.string.drawer_settings
    };
    private static final int[] DRAWER_SECTIONS_PATIENT = {
            R.string.drawer_calendar, R.string.drawer_grocery_list, R.string.drawer_community, R.string.drawer_ping, R.string.drawer_settings
    };
